...
const renderSimilarList = () => {  // Отрисовка похожих карточек только после того, как пользователь захочет открыть окно настроек (хороший тон).
...
const clearSimilarList = () => {  // Очистка списка похожих карточек
